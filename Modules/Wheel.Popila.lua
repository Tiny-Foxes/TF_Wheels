    ...
    for i = 1, 5 do
        ...
        Wheel[#Wheel + 1] = Def.ActorFrame {
            ...
            InitCommand = function(self)
                ...
                if offset == 0 then self:diffuse(.5, .5, .5, 1) end
            end,
            Def.Quad {
                Name = "JacketFrame",
                InitCommand = function(self)
    ...
    return Def.ActorFrame {
        ...
        Def.BitmapText {
            ...
            InitCommand = function(self)
                ...
                self:halign(0):valign(1):xy(-SCREEN_CENTER_X + 12,
                                            SCREEN_CENTER_Y - 26):diffuse(0, 0,
                                                                          0, 1)
                    :zoom(1.8)
            end
        },
        Def.BitmapText {
            ...
            InitCommand = function(self)
                self:SetTextureFiltering(false)
                self:halign(0):valign(1):xy(-SCREEN_CENTER_X + 10,
                                            SCREEN_CENTER_Y - 28):diffuse(1, 1,
                                                                          1, 1)
                    :zoom(1.8)
            end
        }
