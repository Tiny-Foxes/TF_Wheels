...
local function MoveSelection(self, offset, Songs)
    ...
    local pos = TF_WHEEL.CurSong + (18 * offset)
    ...
    elseif offset == 0 then
        ...
        for i = 1, 37 do
            ...
            local pos = TF_WHEEL.CurSong + i - 19
            ...
            -- Same as CDOffset, Stay withing limits.
            while CDSliceOffset > 37 do
                CDSliceOffset = CDSliceOffset - 37
            end
    ...
    for i = 1, 37 do
        ...
        if i == CDSwitch then
            self:GetChild("CDCon"):GetChild("CD" .. i):GetChild("Container")
                :accelerate(1.5):addrotationz(-360):linear(.4):addy(-1280)
        else
            self:GetChild("CDCon"):GetChild("CD" .. i):GetChild("Container")
                :sleep(1.5):linear(.4):y(-1280)
        end
    end
end
        ...
        if TF_WHEEL.MaskMode then
            CDs[#CDs + 1] = Def.ActorFrame {
                ...
                OnCommand = function(self)
                    ...
                    self:rotationz((180 - ((360 / 37) * (i - 19))) * -1):y(-80)
                        :rotationx(-52):SetFOV(80)
                    if CDSwitch == i then self:y(-60) end
                end,
    ...
    return Def.ActorFrame {
        ...
        Def.Sprite {
            ...
            OnCommand = function(self)
                ...
                self:xy(80, 30):zoom(TF_WHEEL.Resize(self:GetWidth(),
        ...
        Def.BitmapText {
            ...
            Font = "_noto sans 40px",
            OnCommand = function(self)
                self:xy(50, -140):diffuse(1, 0, 0, 1):strokecolor(1, 1, 1, 1)
                    :zoom(.5)
            end
        },
        ...
        TriSel .. {
            Name = "Left",
            OnCommand = function(self)
                self:xy(-110, 110):rotationz(-90):diffuse(1, 0, 0, 1)
            end,
