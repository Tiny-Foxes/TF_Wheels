...
local function StartSelection(self, Songs)
	...
	for i = 1, 37 do
		...
		if i == CDSwitch then
			self:GetChild("CDCon"):GetChild("CD" .. i):GetChild("Container"):accelerate(1.5):addrotationz(-360):linear(.4):addy(-
				1280)
		else
...
return function(Style)
	...
	return Def.ActorFrame {
		...
		TriSel .. {
			...
			ColourCommand = function(self) self:sleep(0.02):diffuse(0, 0, 1, 1):sleep(0.02):diffuse(1, 1, 1, 1):sleep(0.02):
				diffuse(1, 0, 0, 1) end
		},
