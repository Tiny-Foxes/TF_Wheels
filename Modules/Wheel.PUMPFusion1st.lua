        ...
        Items[#Items + 1] = Def.ActorFrame {
            Def.ActorFrame {
                OnCommand = function(self)
                    self:xy(SCREEN_CENTER_X - (160 * xoffset),
                            SCREEN_CENTER_Y - (128 * yoffest))
                end,
                Def.Sprite {
                ...
                Def.BitmapText {
                    ...
                    OnCommand = function(self)
                        ...
                        if i < 3 then
                            ...
                            self:diffuse(1, 1, 0, 1):strokecolor(0, 0, 1, 1)
                                :zoom(.5)
                        else
                            self:settext("SHIFT"):diffuse(1, 1, 1, 1)
                                :strokecolor(1, 0, 0, 1):zoom(1):zoomx(1.5)
                        end
                    end
                },
                ...
                Def.BitmapText {
                    ...
                    OnCommand = function(self)
                        ...
                        self:diffuse(0, 0, 0, 1):strokecolor(1, 1, 1, 1)
                            :zoom(.5)
                    end
                },
                ...
                OnCommand = function(self)
                    self:CenterY():rotationz(90 * i):x(SCREEN_CENTER_X -
                                                           (30 * xoffset))
                end,
                Def.Sprite {
                    Texture = THEME:GetPathG("PUMP/pump", "arrow"),
                    OnCommand = function(self)
                        self:zoomto(96, 96):xy(-70, 70):diffuse(0, 0, 1, 1)
                            :queuecommand("Loop")
                    end,
                    LoopCommand = function(self)
                        self:diffusealpha(1):xy(-70, 70):linear(.5):xy(-90, 90)
                            :diffusealpha(0):sleep(.5):queuecommand("Loop")
                    end
                }
            }
        }
